...
extern const int dataBufferSizeMax_R1 = 15;     // 1{A}+dInpSize+dOutSize+aInpSize*5{A+4digit}+1{Z}
extern const int dataBufferSizeMin_R1 = 11;      // 1{A}+dInpSize+dOutSize+aInpSize*2{A+1digit}+1{Z}
